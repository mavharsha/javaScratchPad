...
*
*   number of paths up 100 stairs =  number of paths up 100 stairs when the first leap is 1 step
*                                   + number of paths up 100 stairs when the first leap is 2 steps
*
* */
public class ClimbingStairs {
    ...
    /*
    * Using double for the store instead of Integer because of Integer.MAX_VALUE is 2147483647
    * */
